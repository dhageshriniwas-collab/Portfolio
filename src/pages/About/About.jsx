      ...
      <Page header="About">
        <Text>
          <Paragraph>
            ...
            <br />I was born and raised in Nanded, India. I love to play cricket
            and chess and in my free time I like to read books, watch movies
          ...
          <Educations>
            ...
            <AboutItem
              color={green}
              data={{
                title: "Janta Junior College, Nanded",
            ...
            <AboutItem
              color={yellow}
              data={{
                title: "Savitribai Phule High School, Nanded",
                p: "Secondary Education (2012-2018)",
                image: sos,
              }}
            />
          </Educations>
